...
To learn SQL, we need a Relational Database Software System and a sample/model Database so that we can run queries. Please follow the <a href="https://learn.microsoft.com/en-us/sql/database-engine/install-windows/install-sql-server?view=sql-server-ver16" target="_blank" class="contentLinks">Installation</a> steps for MS SQL Server and then run the following scripts for sample database creation. 
...
<div class="basic_flex_row nextPrev">
    <a href="/">Home</a>
    <a href="/sqlpages/2_sqlcommands">Next</a>
</div>
</Layout>
